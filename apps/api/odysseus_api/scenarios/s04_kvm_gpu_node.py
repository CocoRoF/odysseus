...
SCENARIO = {
    ...
    "difficulty": "hard",
    "briefing_md": (
        "GPU 패스스루로 만든 추론 VM이 베어메탈의 절반도 안 되는 성능을 냅니다. 가끔 부팅도 실패합니다.\n\n"
        "**메신저**를 확인하세요. 도메인 XML과 호스트 정보는 워크스페이스에 있습니다."
    ),
    "agent_enabled": True,
    "characters": [
        {
            ...
            "persona": (
                ...
                "하드웨어 토폴로지는 김도연, 성능 측정은 박지훈에게 물어보라고 안내한다."
            ),
            "knowledge": (
        ...
        },
        {
            ...
            "role": "인프라 엔지니어",
            "color": "#f59e0b",
            "persona": "로그와 출력을 근거로 조목조목 설명한다. XML 을 대신 써주지는 않는다.",
            "knowledge": (
        ...
        },
        {
            ...
            "role": "ML 플랫폼 엔지니어",
            "color": "#0ea5e9",
            "persona": "수치와 계측 결과로 말한다. 원인은 짚어주되 설정 문법은 김도연 소관이라고 넘긴다.",
            "knowledge": (
