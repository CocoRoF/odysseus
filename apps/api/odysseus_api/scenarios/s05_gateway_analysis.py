...
SCENARIO = {
    ...
    "difficulty": "hard",
    "briefing_md": (
        "추론 게이트웨이가 지연 SLO를 못 맞추고 있고, 이번 달 비용도 예산을 넘겼습니다.\n\n"
        "**메신저**를 확인하세요. 로그와 단가표는 워크스페이스에 있습니다."
    ),
    "agent_enabled": True,
    "characters": [
        {
        ...
        },
        {
            ...
            "role": "SRE (게이트웨이 담당)",
            "color": "#f59e0b",
            "persona": "설정 문법과 운영 제약을 정확히 알려준다. 분석 수치는 강태호 소관이라고 넘긴다.",
            "knowledge": (
